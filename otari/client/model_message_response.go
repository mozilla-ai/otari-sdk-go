...
type MessageResponse struct {
	...
	Content     []Content17Inner             `json:"content"`
	...
	Diagnostics          NullableMRBetaDiagnostics               `json:"diagnostics,omitempty"`
...
func (o *MessageResponse) SetContainerNil() {
	o.Container.Set(nil)
}
...
// GetStopDetails returns the StopDetails field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MessageResponse) GetStopDetails() MRRefusalStopDetails {
	if o == nil || IsNil(o.StopDetails.Get()) {
		var ret MRRefusalStopDetails
		return ret
	}
	return *o.StopDetails.Get()
}

// GetStopDetailsOk returns a tuple with the StopDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetStopDetails gets a reference to the given NullableMRRefusalStopDetails and assigns it to the StopDetails field.
...
func (o *MessageResponse) SetStopDetailsNil() {
	o.StopDetails.Set(nil)
}
...
func (o *MessageResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
// SetDiagnostics gets a reference to the given NullableMRBetaDiagnostics and assigns it to the Diagnostics field.
...
func (o MessageResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.StopDetails.IsSet() {
		toSerialize["stop_details"] = o.StopDetails.Get()
	}
...
func (o *MessageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = MessageResponse(varMessageResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "stop_details")
