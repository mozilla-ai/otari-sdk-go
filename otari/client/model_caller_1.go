...
func (dst *Caller1) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(Caller1)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src Caller1) MarshalJSON() ([]byte, error) {
...
type NullableCaller1 struct {
	value *Caller1
	isSet bool
}

func (v NullableCaller1) Get() *Caller1 {
	return v.value
}

func (v *NullableCaller1) Set(val *Caller1) {
	v.value = val
	v.isSet = true
}

func (v NullableCaller1) IsSet() bool {
	return v.isSet
}

func (v *NullableCaller1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaller1(val *Caller1) *NullableCaller1 {
	return &NullableCaller1{value: val, isSet: true}
}

func (v NullableCaller1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaller1) UnmarshalJSON(src []byte) error {
	v.isSet = true
