...
type UpdateToolSettingsRequest struct {
	CodeExecutionExecutor NullableString `json:"code_execution_executor,omitempty"`
...
// GetCodeExecutionExecutor returns the CodeExecutionExecutor field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateToolSettingsRequest) GetCodeExecutionExecutor() string {
	if o == nil || IsNil(o.CodeExecutionExecutor.Get()) {
		var ret string
		return ret
	}
	return *o.CodeExecutionExecutor.Get()
}

// GetCodeExecutionExecutorOk returns a tuple with the CodeExecutionExecutor field value if set, nil otherwise
...
func (o *UpdateToolSettingsRequest) GetCodeExecutionExecutorOk() (*string, bool) {
	...
	return o.CodeExecutionExecutor.Get(), o.CodeExecutionExecutor.IsSet()
}
...
func (o *UpdateToolSettingsRequest) HasCodeExecutionExecutor() bool {
	if o != nil && o.CodeExecutionExecutor.IsSet() {
		return true
	}
...
// SetCodeExecutionExecutor gets a reference to the given NullableString and assigns it to the CodeExecutionExecutor field.
func (o *UpdateToolSettingsRequest) SetCodeExecutionExecutor(v string) {
	o.CodeExecutionExecutor.Set(&v)
}

// SetCodeExecutionExecutorNil sets the value for CodeExecutionExecutor to be an explicit nil
func (o *UpdateToolSettingsRequest) SetCodeExecutionExecutorNil() {
	o.CodeExecutionExecutor.Set(nil)
}
...
func (o UpdateToolSettingsRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.CodeExecutionExecutor.IsSet() {
		toSerialize["code_execution_executor"] = o.CodeExecutionExecutor.Get()
	}
