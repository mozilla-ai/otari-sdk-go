...
`func (o *OrganizationModelPricingCreate) GetUnit() string`

GetUnit returns the Unit field if non-nil, zero value otherwise.

### GetUnitOk

`func (o *OrganizationModelPricingCreate) GetUnitOk() (*string, bool)`
...
`func (o *OrganizationModelPricingCreate) SetUnit(v string)`

SetUnit sets Unit field to given value.

### HasUnit

`func (o *OrganizationModelPricingCreate) HasUnit() bool`
