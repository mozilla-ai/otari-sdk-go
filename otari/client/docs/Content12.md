...
`func NewContent12(errorCode string, type_ string, content string, fileType string, isFileUpdate bool, ) *Content12`
...
`func (o *Content12) GetErrorMessage() string`

GetErrorMessage returns the ErrorMessage field if non-nil, zero value otherwise.

### GetErrorMessageOk

`func (o *Content12) GetErrorMessageOk() (*string, bool)`
...
`func (o *Content12) SetErrorMessage(v string)`

SetErrorMessage sets ErrorMessage field to given value.

### HasErrorMessage

`func (o *Content12) HasErrorMessage() bool`
...
`func (o *Content12) GetContent() string`

GetContent returns the Content field if non-nil, zero value otherwise.

### GetContentOk

`func (o *Content12) GetContentOk() (*string, bool)`
...
`func (o *Content12) SetContent(v string)`
...
`func (o *Content12) GetFileType() string`

GetFileType returns the FileType field if non-nil, zero value otherwise.

### GetFileTypeOk

`func (o *Content12) GetFileTypeOk() (*string, bool)`
...
`func (o *Content12) SetFileType(v string)`
...
`func (o *Content12) GetNumLines() int32`

GetNumLines returns the NumLines field if non-nil, zero value otherwise.

### GetNumLinesOk

`func (o *Content12) GetNumLinesOk() (*int32, bool)`
...
`func (o *Content12) SetIsFileUpdate(v bool)`
...
`func (o *Content12) GetLines() []string`

GetLines returns the Lines field if non-nil, zero value otherwise.

### GetLinesOk

`func (o *Content12) GetLinesOk() (*[]string, bool)`
...
`func (o *Content12) SetLines(v []string)`

SetLines sets Lines field to given value.

### HasLines

`func (o *Content12) HasLines() bool`

HasLines returns a boolean if a field has been set.

### GetNewLines

`func (o *Content12) GetNewLines() int32`

GetNewLines returns the NewLines field if non-nil, zero value otherwise.

### GetNewLinesOk

`func (o *Content12) GetNewLinesOk() (*int32, bool)`
...
`func (o *Content12) SetOldStart(v int32)`

SetOldStart sets OldStart field to given value.

### HasOldStart

`func (o *Content12) HasOldStart() bool`
