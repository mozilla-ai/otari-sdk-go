...
func main() {
	...
	countsTowardBudget := true // bool | Filter by budget participation: true = only enforced gateway rows, false = only imported rows, narrowed past the filter of the same name on GET /api/v1/usage so the total matches what bulk delete and set-price can reach (optional)
	...
	// response from `UsageCountUsage`: UsageCount
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageCountUsage`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageCountUsageRequest struct via the builder pattern
 ...
 **countsTowardBudget** | **bool** | Filter by budget participation: true &#x3D; only enforced gateway rows, false &#x3D; only imported rows, narrowed past the filter of the same name on GET /api/v1/usage so the total matches what bulk delete and set-price can reach | 
...
> UsageDeleteResult UsageDeleteUsageRows(ctx).UsageDeleteRequest(usageDeleteRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UsageAPI.UsageDeleteUsageRows(context.Background()).UsageDeleteRequest(usageDeleteRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UsageAPI.UsageDeleteUsageRows``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UsageDeleteUsageRows`: UsageDeleteResult
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageDeleteUsageRows`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageDeleteUsageRowsRequest struct via the builder pattern
...
> ExternalIngestResult UsageIngestExternalUsage(ctx).ExternalEventsRequest(externalEventsRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UsageAPI.UsageIngestExternalUsage(context.Background()).ExternalEventsRequest(externalEventsRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UsageAPI.UsageIngestExternalUsage``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UsageIngestExternalUsage`: ExternalIngestResult
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageIngestExternalUsage`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageIngestExternalUsageRequest struct via the builder pattern
...
> InFlightResponse UsageListInFlight(ctx).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UsageAPI.UsageListInFlight(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UsageAPI.UsageListInFlight``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UsageListInFlight`: InFlightResponse
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageListInFlight`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageListInFlightRequest struct via the builder pattern
...
func main() {
	...
	// response from `UsageListUsage`: []UsageEntry
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageListUsage`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageListUsageRequest struct via the builder pattern
...
> UsageSetPriceResult UsageSetUsagePriceRows(ctx).UsageSetPriceRequest(usageSetPriceRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UsageAPI.UsageSetUsagePriceRows(context.Background()).UsageSetPriceRequest(usageSetPriceRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UsageAPI.UsageSetUsagePriceRows``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UsageSetUsagePriceRows`: UsageSetPriceResult
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageSetUsagePriceRows`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageSetUsagePriceRowsRequest struct via the builder pattern
...
func main() {
	...
	// response from `UsageUsageSeries`: UsageGroupedSeries
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageUsageSeries`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageUsageSeriesRequest struct via the builder pattern
...
func main() {
	...
	// response from `UsageUsageSummary`: UsageSummary
	fmt.Fprintf(os.Stdout, "Response from `UsageAPI.UsageUsageSummary`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUsageUsageSummaryRequest struct via the builder pattern
