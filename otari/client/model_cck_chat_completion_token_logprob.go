...
// checks if the CCKChatCompletionTokenLogprob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CCKChatCompletionTokenLogprob{}

// CCKChatCompletionTokenLogprob struct for CCKChatCompletionTokenLogprob
type CCKChatCompletionTokenLogprob struct {
...
type _CCKChatCompletionTokenLogprob CCKChatCompletionTokenLogprob
...
func NewCCKChatCompletionTokenLogprob(token string, logprob float32, topLogprobs []CCKTopLogprob) *CCKChatCompletionTokenLogprob {
	this := CCKChatCompletionTokenLogprob{}
	this.Token = token
...
func (o CCKChatCompletionTokenLogprob) MarshalJSON() ([]byte, error) {
...
func (o CCKChatCompletionTokenLogprob) ToMap() (map[string]interface{}, error) {
...
func (o *CCKChatCompletionTokenLogprob) UnmarshalJSON(data []byte) (err error) {
	...
	varCCKChatCompletionTokenLogprob := _CCKChatCompletionTokenLogprob{}

	err = json.Unmarshal(data, &varCCKChatCompletionTokenLogprob)

	if err != nil {
		return err
	}

	*o = CCKChatCompletionTokenLogprob(varCCKChatCompletionTokenLogprob)
...
type NullableCCKChatCompletionTokenLogprob struct {
	value *CCKChatCompletionTokenLogprob
	isSet bool
}

func (v NullableCCKChatCompletionTokenLogprob) Get() *CCKChatCompletionTokenLogprob {
	return v.value
}

func (v *NullableCCKChatCompletionTokenLogprob) Set(val *CCKChatCompletionTokenLogprob) {
	v.value = val
	v.isSet = true
}

func (v NullableCCKChatCompletionTokenLogprob) IsSet() bool {
	return v.isSet
}

func (v *NullableCCKChatCompletionTokenLogprob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCCKChatCompletionTokenLogprob(val *CCKChatCompletionTokenLogprob) *NullableCCKChatCompletionTokenLogprob {
	return &NullableCCKChatCompletionTokenLogprob{value: val, isSet: true}
}

func (v NullableCCKChatCompletionTokenLogprob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCCKChatCompletionTokenLogprob) UnmarshalJSON(src []byte) error {
	v.isSet = true
