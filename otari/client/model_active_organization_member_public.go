...
type ActiveOrganizationMemberPublic struct {
	Attribution          NullableMemberAttributionPublic  `json:"attribution,omitempty"`
	...
	Workspaces           []MemberWorkspacePlacementPublic `json:"workspaces,omitempty"`
}
...
func (o *ActiveOrganizationMemberPublic) GetAttribution() MemberAttributionPublic {
	if o == nil || IsNil(o.Attribution.Get()) {
		var ret MemberAttributionPublic
		return ret
	}
	return *o.Attribution.Get()
}
...
// SetAttribution gets a reference to the given NullableMemberAttributionPublic and assigns it to the Attribution field.
...
func (o *ActiveOrganizationMemberPublic) SetAttributionNil() {
	o.Attribution.Set(nil)
}
...
func (o *ActiveOrganizationMemberPublic) GetWorkspaces() []MemberWorkspacePlacementPublic {
	if o == nil || IsNil(o.Workspaces) {
		var ret []MemberWorkspacePlacementPublic
		return ret
	}
	return o.Workspaces
}
...
// SetWorkspaces gets a reference to the given []MemberWorkspacePlacementPublic and assigns it to the Workspaces field.
...
func (o ActiveOrganizationMemberPublic) ToMap() (map[string]interface{}, error) {
	...
	if o.Attribution.IsSet() {
		toSerialize["attribution"] = o.Attribution.Get()
	}
