...
// GetNeedsPassword returns the NeedsPassword field value
...
// GetNeedsPasswordOk returns a tuple with the NeedsPassword field value
// and a boolean to check if the value has been set.
...
// SetNeedsPassword sets field value
