...
// checks if the CatalogModelDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogModelDetail{}

// CatalogModelDetail One model with everything the detail page shows.
type CatalogModelDetail struct {
	AlsoAvailableFrom []CatalogElsewhere  `json:"also_available_from"`
...
type _CatalogModelDetail CatalogModelDetail
...
func NewCatalogModelDetail(alsoAvailableFrom []CatalogElsewhere, capabilities CatalogCapabilities, defaultPricing bool, discovered bool, id string, inputModalities []string, name string, offeringCount int32, offerings []CatalogOffering, outputModalities []string, priceSources []string, providerCount int32, providers []string, selectors []string, unpricedCount int32, vendor NullableString) *CatalogModelDetail {
	this := CatalogModelDetail{}
	this.AlsoAvailableFrom = alsoAvailableFrom
...
// GetAlsoAvailableFrom returns the AlsoAvailableFrom field value
func (o *CatalogModelDetail) GetAlsoAvailableFrom() []CatalogElsewhere {
	if o == nil {
		var ret []CatalogElsewhere
		return ret
	}

	return o.AlsoAvailableFrom
}

// GetAlsoAvailableFromOk returns a tuple with the AlsoAvailableFrom field value
// and a boolean to check if the value has been set.
func (o *CatalogModelDetail) GetAlsoAvailableFromOk() ([]CatalogElsewhere, bool) {
	if o == nil {
		return nil, false
	}
	return o.AlsoAvailableFrom, true
}

// SetAlsoAvailableFrom sets field value
func (o *CatalogModelDetail) SetAlsoAvailableFrom(v []CatalogElsewhere) {
	o.AlsoAvailableFrom = v
}
...
func (o *CatalogModelDetail) SetContextWindowNil() {
...
func (o *CatalogModelDetail) SetDescriptionNil() {
...
func (o *CatalogModelDetail) SetFamilyNil() {
	o.Family.Set(nil)
}
...
func (o *CatalogModelDetail) SetKnowledgeCutoffNil() {
...
func (o *CatalogModelDetail) SetMaxOutputTokensNil() {
...
func (o *CatalogModelDetail) SetMinInputPricePerMillionNil() {
...
func (o *CatalogModelDetail) SetMinOutputPricePerMillionNil() {
...
func (o *CatalogModelDetail) SetReleaseDateNil() {
...
func (o *CatalogModelDetail) SetResolvesToNil() {
...
func (o *CatalogModelDetail) SetSelectorNil() {
	o.Selector.Set(nil)
}
...
func (o CatalogModelDetail) MarshalJSON() ([]byte, error) {
...
func (o CatalogModelDetail) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["also_available_from"] = o.AlsoAvailableFrom
...
func (o *CatalogModelDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogModelDetail := _CatalogModelDetail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogModelDetail)

	if err != nil {
		return err
	}

	*o = CatalogModelDetail(varCatalogModelDetail)

	return err
}

type NullableCatalogModelDetail struct {
	value *CatalogModelDetail
	isSet bool
}

func (v NullableCatalogModelDetail) Get() *CatalogModelDetail {
	return v.value
}

func (v *NullableCatalogModelDetail) Set(val *CatalogModelDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogModelDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogModelDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogModelDetail(val *CatalogModelDetail) *NullableCatalogModelDetail {
	return &NullableCatalogModelDetail{value: val, isSet: true}
}

func (v NullableCatalogModelDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogModelDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
