...
type DeploymentBootstrap struct {
	...
	SiteUrl NullableString `json:"site_url"`
...
// GetFeedbackEnabled returns the FeedbackEnabled field value
...
// GetFeedbackEnabledOk returns a tuple with the FeedbackEnabled field value
// and a boolean to check if the value has been set.
...
// SetFeedbackEnabled sets field value
...
// GetOpenSignup returns the OpenSignup field value
...
// GetOpenSignupOk returns a tuple with the OpenSignup field value
// and a boolean to check if the value has been set.
func (o *DeploymentBootstrap) GetOpenSignupOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OpenSignup, true
}

// SetOpenSignup sets field value
...
// GetPublicCatalog returns the PublicCatalog field value if set, zero value otherwise.
func (o *DeploymentBootstrap) GetPublicCatalog() bool {
	if o == nil || IsNil(o.PublicCatalog) {
		var ret bool
		return ret
	}
	return *o.PublicCatalog
}
...
// SetPublicCatalog gets a reference to the given bool and assigns it to the PublicCatalog field.
...
func (o DeploymentBootstrap) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["feedback_enabled"] = o.FeedbackEnabled
