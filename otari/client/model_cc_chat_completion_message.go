...
type CCChatCompletionMessage struct {
	...
	Images               []CCImageContent       `json:"images,omitempty"`
...
// SetImages gets a reference to the given []CCImageContent and assigns it to the Images field.
