...
// checks if the MRBetaBashCodeExecutionResultBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MRBetaBashCodeExecutionResultBlock{}

// MRBetaBashCodeExecutionResultBlock struct for MRBetaBashCodeExecutionResultBlock
type MRBetaBashCodeExecutionResultBlock struct {
	Content              []MRBetaBashCodeExecutionOutputBlock `json:"content"`
...
type _MRBetaBashCodeExecutionResultBlock MRBetaBashCodeExecutionResultBlock
...
func NewMRBetaBashCodeExecutionResultBlock(content []MRBetaBashCodeExecutionOutputBlock, returnCode int32, stderr string, stdout string, type_ string) *MRBetaBashCodeExecutionResultBlock {
	this := MRBetaBashCodeExecutionResultBlock{}
...
func (o *MRBetaBashCodeExecutionResultBlock) GetContent() []MRBetaBashCodeExecutionOutputBlock {
	if o == nil {
		var ret []MRBetaBashCodeExecutionOutputBlock
		return ret
	}
...
func (o MRBetaBashCodeExecutionResultBlock) MarshalJSON() ([]byte, error) {
...
func (o MRBetaBashCodeExecutionResultBlock) ToMap() (map[string]interface{}, error) {
...
func (o *MRBetaBashCodeExecutionResultBlock) UnmarshalJSON(data []byte) (err error) {
	...
	varMRBetaBashCodeExecutionResultBlock := _MRBetaBashCodeExecutionResultBlock{}

	err = json.Unmarshal(data, &varMRBetaBashCodeExecutionResultBlock)

	if err != nil {
		return err
	}

	*o = MRBetaBashCodeExecutionResultBlock(varMRBetaBashCodeExecutionResultBlock)
...
type NullableMRBetaBashCodeExecutionResultBlock struct {
	value *MRBetaBashCodeExecutionResultBlock
	isSet bool
}

func (v NullableMRBetaBashCodeExecutionResultBlock) Get() *MRBetaBashCodeExecutionResultBlock {
	return v.value
}

func (v *NullableMRBetaBashCodeExecutionResultBlock) Set(val *MRBetaBashCodeExecutionResultBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableMRBetaBashCodeExecutionResultBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableMRBetaBashCodeExecutionResultBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMRBetaBashCodeExecutionResultBlock(val *MRBetaBashCodeExecutionResultBlock) *NullableMRBetaBashCodeExecutionResultBlock {
	return &NullableMRBetaBashCodeExecutionResultBlock{value: val, isSet: true}
}

func (v NullableMRBetaBashCodeExecutionResultBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMRBetaBashCodeExecutionResultBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
