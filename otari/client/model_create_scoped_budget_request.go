...
// checks if the CreateScopedBudgetRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateScopedBudgetRequest{}

// CreateScopedBudgetRequest Request model for creating a scoped budget.
type CreateScopedBudgetRequest struct {
...
type _CreateScopedBudgetRequest CreateScopedBudgetRequest
...
func NewCreateScopedBudgetRequest(budgetId string, scopeId string, scopeType string) *CreateScopedBudgetRequest {
	this := CreateScopedBudgetRequest{}
...
func (o *CreateScopedBudgetRequest) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CreateScopedBudgetRequest) SetProviderKeyIdNil() {
...
func (o CreateScopedBudgetRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateScopedBudgetRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateScopedBudgetRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateScopedBudgetRequest := _CreateScopedBudgetRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateScopedBudgetRequest)

	if err != nil {
		return err
	}

	*o = CreateScopedBudgetRequest(varCreateScopedBudgetRequest)

	return err
}

type NullableCreateScopedBudgetRequest struct {
	value *CreateScopedBudgetRequest
	isSet bool
}

func (v NullableCreateScopedBudgetRequest) Get() *CreateScopedBudgetRequest {
	return v.value
}

func (v *NullableCreateScopedBudgetRequest) Set(val *CreateScopedBudgetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateScopedBudgetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateScopedBudgetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateScopedBudgetRequest(val *CreateScopedBudgetRequest) *NullableCreateScopedBudgetRequest {
	return &NullableCreateScopedBudgetRequest{value: val, isSet: true}
}

func (v NullableCreateScopedBudgetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateScopedBudgetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
