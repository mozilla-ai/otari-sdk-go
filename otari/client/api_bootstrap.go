...
type ApiBootstrapGetBootstrapRequest struct {
	ctx        context.Context
	ApiService *BootstrapAPIService
}

func (r ApiBootstrapGetBootstrapRequest) Execute() (*DeploymentBootstrap, *http.Response, error) {
	return r.ApiService.BootstrapGetBootstrapExecute(r)
}

/*
BootstrapGetBootstrap Get Bootstrap
...
and “get_db_if_needed“ hands it no session to read one from.
	...
	@return ApiBootstrapGetBootstrapRequest
*/
func (a *BootstrapAPIService) BootstrapGetBootstrap(ctx context.Context) ApiBootstrapGetBootstrapRequest {
	return ApiBootstrapGetBootstrapRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *BootstrapAPIService) BootstrapGetBootstrapExecute(r ApiBootstrapGetBootstrapRequest) (*DeploymentBootstrap, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BootstrapAPIService.BootstrapGetBootstrap")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/bootstrap"
