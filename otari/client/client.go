...
// APIClient manages communication with the otari API v0.12.1
...
type APIClient struct {
	...
	OrganizationGuardrailDefinitionsAPI *OrganizationGuardrailDefinitionsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.OrganizationGuardrailDefinitionsAPI = (*OrganizationGuardrailDefinitionsAPIService)(&c.common)
