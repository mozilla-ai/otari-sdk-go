...
type WorkspaceCodeExecutionPolicyUpdate struct {
	...
	Executor NullableCodeExecutor `json:"executor,omitempty"`
...
// SetExecutor gets a reference to the given NullableCodeExecutor and assigns it to the Executor field.
...
func (o *WorkspaceCodeExecutionPolicyUpdate) SetExecutorNil() {
	o.Executor.Set(nil)
}
