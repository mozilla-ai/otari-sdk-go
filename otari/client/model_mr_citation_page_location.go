...
// checks if the MRCitationPageLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MRCitationPageLocation{}

// MRCitationPageLocation struct for MRCitationPageLocation
type MRCitationPageLocation struct {
...
type _MRCitationPageLocation MRCitationPageLocation
...
func (o *MRCitationPageLocation) SetDocumentTitleNil() {
...
func (o *MRCitationPageLocation) SetFileIdNil() {
	o.FileId.Set(nil)
}
...
func (o MRCitationPageLocation) MarshalJSON() ([]byte, error) {
...
func (o MRCitationPageLocation) ToMap() (map[string]interface{}, error) {
...
func (o *MRCitationPageLocation) UnmarshalJSON(data []byte) (err error) {
	...
	varMRCitationPageLocation := _MRCitationPageLocation{}

	err = json.Unmarshal(data, &varMRCitationPageLocation)

	if err != nil {
		return err
	}

	*o = MRCitationPageLocation(varMRCitationPageLocation)
...
type NullableMRCitationPageLocation struct {
	value *MRCitationPageLocation
	isSet bool
}

func (v NullableMRCitationPageLocation) Get() *MRCitationPageLocation {
	return v.value
}

func (v *NullableMRCitationPageLocation) Set(val *MRCitationPageLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableMRCitationPageLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableMRCitationPageLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMRCitationPageLocation(val *MRCitationPageLocation) *NullableMRCitationPageLocation {
	return &NullableMRCitationPageLocation{value: val, isSet: true}
}

func (v NullableMRCitationPageLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMRCitationPageLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
