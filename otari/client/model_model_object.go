...
func NewModelObject(created int32, id string, ownedBy string) *ModelObject {
	...
	var deploymentManaged bool = false
	this.DeploymentManaged = &deploymentManaged
	this.Id = id
...
// GetDeploymentManaged returns the DeploymentManaged field value if set, zero value otherwise.
func (o *ModelObject) GetDeploymentManaged() bool {
	if o == nil || IsNil(o.DeploymentManaged) {
		var ret bool
		return ret
	}
	return *o.DeploymentManaged
}

// GetDeploymentManagedOk returns a tuple with the DeploymentManaged field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelObject) GetDeploymentManagedOk() (*bool, bool) {
	if o == nil || IsNil(o.DeploymentManaged) {
		return nil, false
	}
	return o.DeploymentManaged, true
}
...
// SetDeploymentManaged gets a reference to the given bool and assigns it to the DeploymentManaged field.
func (o *ModelObject) SetDeploymentManaged(v bool) {
	o.DeploymentManaged = &v
}
...
func (o ModelObject) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeploymentManaged) {
		toSerialize["deployment_managed"] = o.DeploymentManaged
	}
	toSerialize["id"] = o.Id
	if !IsNil(o.Object) {
