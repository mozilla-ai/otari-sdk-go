...
type MessagesRequest struct {
	...
	Container         NullableContainer        `json:"container,omitempty"`
...
// SetContainer gets a reference to the given NullableContainer and assigns it to the Container field.
